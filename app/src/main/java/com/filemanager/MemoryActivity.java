...
public class MemoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (version == 23) { DetialVersion.setText("6.0.0"); }
        else if (version ==22){ DetialVersion.setText("5.1.0"); }
        else if (version ==21){ DetialVersion.setText("5.0.0"); }
        else if (version ==20){ DetialVersion.setText("4.4.0 W"); }
        else if (version ==19){ DetialVersion.setText("4.4.0"); }
        else if (version ==18){ DetialVersion.setText("4.3.0"); }
        else if (version ==17){ DetialVersion.setText("4.2.0"); }
        else if (version ==16){ DetialVersion.setText("4.1.0"); }
        else if (version ==15){ DetialVersion.setText("4.0.0"); }
        else if (version <=14){ DetialVersion.setText("恭喜，你是地球上Android版本最低的3%的人之一。"); }
